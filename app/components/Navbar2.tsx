...
const Navbar: React.FC<NavbarProps> = ({
   ...
   return (
      <nav className="absolute top-0 left-0 w-full z-10 lg:flex-row lg:flex-nowrap lg:justify-start flex items-center py-4 px-4 bg-white text-gray-700 dark:bg-[#28253b] dark:text-white">
